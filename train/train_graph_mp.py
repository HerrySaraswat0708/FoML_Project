...
def train_and_evaluate(
    ...
    model = GraphMP(in_channels=input_dim, out_channels=hidden_channels, global_dim=global_dim, edge_dim=edge_dim)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train and evaluate the custom message-passing graph model.")
