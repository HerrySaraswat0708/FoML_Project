...
def train_and_evaluate(
    ...
    model = GraphNET(in_channels=input_dim, out_channels=hidden_channels)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train and evaluate the attention-style graph model.")
